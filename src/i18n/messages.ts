...
const ja = {
  ...
  'diag.source': '取得元',
  'diag.gravity': '重力ベクトル',
  'diag.embedded': '埋め込み表示',
  'diag.reason': '失敗した理由',
  'diag.yes': 'はい',
  'diag.no': 'いいえ',
  'reason.none': '—',
  'reason.embedded': '埋め込みのため iOS が許可を出さない',
  'reason.denied': 'iOS が許可を拒否した',
  'reason.unsupported': 'この環境にセンサーが無い',
  'reason.noData': '許可は下りたが値が届かない',
...
const en: Record<MessageKey, string> = {
  ...
  'diag.embedded': 'Embedded view',
  'diag.reason': 'Why it failed',
  'diag.yes': 'Yes',
  'diag.no': 'No',
  'reason.none': '—',
  'reason.embedded': 'iOS refuses access inside an embedded view',
  'reason.denied': 'iOS denied the permission',
  'reason.unsupported': 'No sensor in this environment',
  'reason.noData': 'Permission granted but no values arrive',
